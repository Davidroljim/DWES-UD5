...
<body>
    ...
    <tr>
        <td>session.use_cookies</td><td>session.use_cookies especifica si el módulo usará cookies para almacenar el id de sesión en la parte del cliente. Por defecto es 1 (habilitado).</td><td>0,1</td>
    </tr>
    <tr>
        <td>session.use_only_cookies</td><td>session.use_only_cookies especifica si el módulo sólo usará cookies para almacenar el id de sesión en la parte del cliente. Habilitar este ajuste previene ataques que implican pasar el id de sesión en la URL. Por defecto es 1 (habilitado).</td><td>0,1</td>
    </tr>
    <tr> 
    ...
    <tr>
        <td>session.auto_start</td><td>session.auto_start especifica si el módulo de sesión inicia una sesión automáticamente cuando arranque una petición. Por defecto es 0 (deshabilitado).</td><td>0,1</td>
    </tr>
    <tr>
